...
ALL_ITEMS = [
    ...
    "Short Stud Florin Display Pot (D)",
    ...
    "Tall Stud Florin Display Pot (D)", "Teapots (U)", "Tent (R)", "Toilet 1 (R)",
    "Toilet 2 (R)", "Traditional Japanese Lantern (R)", "Tree (R)", "Tree House (D)",
...
ITEM_MAP = {
    ...
    "sshfdp": "Short Shrine Florin Display Pot (D)",
    "sstfdp": "Short Stud Florin Display Pot (D)",
    ...
    "tshfdp": "Tall Shrine Florin Display Pot (D)", 
    "tstfdp": "Tall Stud Florin Display Pot (D)", "tea": "Teapots (U)",
...
async def on_message(message):
    ...
    ping_message = role_mention.strip() + "\nITEMS IN STOCK:\n" + bullet_list
